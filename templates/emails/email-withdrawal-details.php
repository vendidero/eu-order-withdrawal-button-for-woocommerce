...
<ul style="margin-bottom: <?php echo $email_improvements_enabled ? '24px' : '40px'; ?>;">
	...
	<li><strong><?php echo wp_kses_post( _x( 'Received on', 'owb', 'eu-order-withdrawal-button-for-woocommerce' ) ); ?>:</strong> <span class="text"><?php echo wp_kses_post( wc_format_datetime( eu_owb_get_order_withdrawal_date( $order ) ) ); ?></span></li>
