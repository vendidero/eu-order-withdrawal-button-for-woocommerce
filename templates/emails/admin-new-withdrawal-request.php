...
<?php echo $email_improvements_enabled ? '<div class="email-introduction">' : ''; ?>
	<p><?php printf( esc_html_x( 'You’ve received a new withdrawal request for order #%s:', 'owb', 'eu-order-withdrawal-button-for-woocommerce' ), esc_html( $order->get_order_number() ) ); ?></p>
