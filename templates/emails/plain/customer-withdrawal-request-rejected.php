<?php
/**
 * Customer withdrawal request rejected email
 *
 * This template can be overridden by copying it to yourtheme/woocommerce/emails/customer-withdrawal-request-rejected.php.
 *
...
if ( ! empty( $withdrawal_name ) ) {
	...
	echo sprintf( esc_html_x( 'Hi %s,', 'owb', 'eu-order-withdrawal-button-for-woocommerce' ), esc_html( $withdrawal_name ) ) . "\n\n";
} else {
	echo esc_html_x( 'Hi,', 'owb', 'eu-order-withdrawal-button-for-woocommerce' ) . "\n\n";
}

echo esc_html_x( 'We regret to inform you that your withdrawal request has been rejected.', 'owb', 'eu-order-withdrawal-button-for-woocommerce' ) . "\n\n";
