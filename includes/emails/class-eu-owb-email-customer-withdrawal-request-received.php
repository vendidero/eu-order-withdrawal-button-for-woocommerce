...
if ( ! class_exists( 'EU_OWB_Email_Customer_Withdrawal_Request_Received', false ) ) :
	...
	class EU_OWB_Email_Customer_Withdrawal_Request_Received extends WC_Email {
		...
		public function __construct() {
			...
			$this->title          = _x( 'Withdrawal request received', 'owb', 'eu-order-withdrawal-button-for-woocommerce' );
			$this->description    = _x( 'Confirm that the withdrawal request has been received.', 'owb', 'eu-order-withdrawal-button-for-woocommerce' );
		...
		public function get_default_heading( $partial = false ) {
			if ( $partial ) {
				return _x( 'We received your partial withdrawal request', 'owb', 'eu-order-withdrawal-button-for-woocommerce' );
			} else {
				return _x( 'We received your withdrawal request', 'owb', 'eu-order-withdrawal-button-for-woocommerce' );
			}
		}
		...
		public function init_form_fields() {
			...
			$placeholder_text = sprintf( _x( 'Available placeholders: %s', 'owb', 'eu-order-withdrawal-button-for-woocommerce' ), '<code>' . esc_html( implode( '</code>, <code>', array_keys( $this->placeholders ) ) ) . '</code>' );

			$this->form_fields = array(
				'enabled'            => array(
					'title'   => _x( 'Enable/Disable', 'owb', 'eu-order-withdrawal-button-for-woocommerce' ),
					'type'    => 'checkbox',
					'label'   => _x( 'Enable this email notification', 'owb', 'eu-order-withdrawal-button-for-woocommerce' ),
					'default' => 'yes',
				),
				'subject_full'       => array(
					'title'       => _x( 'Full withdrawal subject', 'owb', 'eu-order-withdrawal-button-for-woocommerce' ),
					'type'        => 'text',
					'desc_tip'    => true,
				...
				'subject_partial'    => array(
					'title'       => _x( 'Partial withdrawal subject', 'owb', 'eu-order-withdrawal-button-for-woocommerce' ),
					'type'        => 'text',
					'desc_tip'    => true,
					'description' => $placeholder_text,
				...
				'heading_full'       => array(
					'title'       => _x( 'Full withdrawal email heading', 'owb', 'eu-order-withdrawal-button-for-woocommerce' ),
					'type'        => 'text',
					'desc_tip'    => true,
					'description' => $placeholder_text,
				...
				'heading_partial'    => array(
					'title'       => _x( 'Partial withdrawal email heading', 'owb', 'eu-order-withdrawal-button-for-woocommerce' ),
					'type'        => 'text',
					'desc_tip'    => true,
					'description' => $placeholder_text,
				...
				'additional_content' => array(
					'title'       => _x( 'Additional content', 'owb', 'eu-order-withdrawal-button-for-woocommerce' ),
					'description' => _x( 'Text to appear below the main email content.', 'owb', 'eu-order-withdrawal-button-for-woocommerce' ) . ' ' . $placeholder_text,
					'css'         => 'width:400px; height: 75px;',
					'placeholder' => _x( 'N/A', 'owb', 'eu-order-withdrawal-button-for-woocommerce' ),
					'type'        => 'textarea',
					'default'     => $this->get_default_additional_content(),
					'desc_tip'    => true,
				),
				'email_type'         => array(
					'title'       => _x( 'Email type', 'owb', 'eu-order-withdrawal-button-for-woocommerce' ),
					'type'        => 'select',
					'description' => _x( 'Choose which format of email to send.', 'owb', 'eu-order-withdrawal-button-for-woocommerce' ),
					'default'     => 'html',
