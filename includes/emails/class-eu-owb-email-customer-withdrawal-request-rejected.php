...
if ( ! class_exists( 'EU_OWB_Email_Customer_Withdrawal_Request_Rejected', false ) ) :
	...
	class EU_OWB_Email_Customer_Withdrawal_Request_Rejected extends WC_Email {
		...
		public function __construct() {
			...
			$this->title          = _x( 'Withdrawal request rejected', 'owb', 'eu-order-withdrawal-button-for-woocommerce' );
			$this->description    = _x( 'Informs the customer that their withdrawal request has been rejected.', 'owb', 'eu-order-withdrawal-button-for-woocommerce' );
		...
		public function get_default_subject() {
			return _x( 'Your withdrawal request for order #{order_number} has been rejected.', 'owb', 'eu-order-withdrawal-button-for-woocommerce' );
		}
		...
		public function get_default_heading( $partial = false ) {
			return _x( 'Your withdrawal request has been rejected.', 'owb', 'eu-order-withdrawal-button-for-woocommerce' );
		}
		 ...
		 */
		public function trigger( $order_id, $order = false, $recipient = '', $reason = '', $is_partial_withdrawal = null ) {
			$this->setup_locale();
